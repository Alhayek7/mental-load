...
-- ============================================================
-- 16. Trigger: تحديث updated_at تلقائياً (اختياري)
-- ============================================================
...
-- ============================================================
-- 20. بيانات اختبارية (للاختبار فقط)
-- ============================================================
...
--   cognitive_load_score,
--   COUNT(*) AS count,
--   ROUND(COUNT(*)::numeric / (SELECT COUNT(*) FROM checkins) * 100, 2) AS percentage
-- FROM checkins
-- WHERE user_id = 'your-user-id'
...
-- SELECT 
--   CASE 
--     WHEN was_followed = TRUE THEN 'Followed'
--     ELSE 'Ignored'
--   END AS action,
--   ROUND(AVG(effect_on_next_score)::numeric, 2) AS avg_effect
-- FROM recommendations_history
-- WHERE effect_on_next_score IS NOT NULL
-- GROUP BY was_followed;

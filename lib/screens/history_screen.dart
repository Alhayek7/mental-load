  ...
  switch (cleanCategory) {
    case 'Low':
      return {
        ...
        'label': 'Low Load',
        'description': '✅ Your cognitive load is low. You\'re managing your mental energy well. Keep up the great habits!',
      };
    case 'Medium':
      return {
        'icon': Icons.info_outline,
        'label': 'Medium Load',
        'description': '📊 Moderate cognitive load detected. Consider taking short breaks and monitoring your AI usage to maintain balance.',
      };
    case 'High':
      return {
        'icon': Icons.warning_amber_rounded,
        'label': 'High Load',
        'description': '⚠️ High cognitive load detected. Take immediate action: reduce AI tools, take a 20-minute break, and practice deep breathing.',
      };
    default:
      return {
        'icon': Icons.analytics_outlined,
        'label': 'Analyzed',
        'description': 'Cognitive load analysis completed. Review your score for insights.',
      };
  }
}
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      Row(
                        children: [
                          Icon(Icons.text_fields, color: const Color(0xFF8A8A9A), size: 16),
                          const SizedBox(width: 8),
                          Text(
                            'Your Reflection',
                            style: TextStyle(
          ...
          children: [
            ...
            Text(
              ...
              style: TextStyle(
                ...
                fontWeight: FontWeight.w400,
                color: isLow
                    ? const Color(0xFF2D6A4F).withValues(alpha: 0.8)
                    : isMedium
                        ? const Color(0xFFF4A261).withValues(alpha: 0.8)
                        : const Color(0xFFE76F51).withValues(alpha: 0.8),
                height: 1.5,
              ),
            ),
          ],
